...
namespace Microsoft.WindowsAPICodePack.Samples
{
    ...
    public partial class ExplorerBrowserTestWindow : Window
    {
        ...
        private void navigateFileButton_Click(object sender, RoutedEventArgs e)
        {
		   ...
		   //Microsoft.WindowsAPICodePack.Shell.PropertySystem.SystemProperties.System.FileName, "*.*",
		   //SearchConditionOperation.Equal);
		   //	 ShellSearchFolder searchFolder = new ShellSearchFolder(fileNameCondition, navigateFileTextBox.Text);
		   //	 eb.ExplorerBrowserControl.Navigate(searchFolder);
            }
            catch
            {
